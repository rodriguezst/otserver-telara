...
SvargrondArena = {
	...
	kickTime = 600,
	kickPosition = Position(1498, 1362, 7),
	rewardPosition = Position(1805, 1478, 5),
...
local firstPit = {
	fromPos = {x = 1795, y = 1506, z = 6},
	toPos = {x = 1804, y = 1506, z = 6},
	center = {x = 1800, y = 1510, z = 6},
	pillar = {x = 1794, y = 1510, z = 6},
	tp = {x = 1794, y = 1510, z = 6},
	summon = {x = 1795, y = 1508, z = 6}
}
