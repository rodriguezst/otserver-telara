local table = 
{
	...
	[10] = {type = "mount", id = {3, 0}, msg = "Voce ganhou a montaria War Bear!"},
	[100] = {type = "mount", id = {16, 0}, msg = "Voce ganhou a montaria Crystal Wolf!"},
	[200] = {type = "mount", id = {39, 0}, msg = "Voce ganhou a montaria The Hellgrip!"},
}
