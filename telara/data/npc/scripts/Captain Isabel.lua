...
addTravelKeyword('verona', 30, Position(561, 864, 6))
addTravelKeyword('bluffgard', 95, Position(580, 611, 6))
addTravelKeyword('woundhill bay', 90, Position(766, 863,6))
addTravelKeyword('niflheim', 95, Position(423, 311,6))
addTravelKeyword('salazart', 85, Position(1146, 771,6))
addTravelKeyword('feldarin', 105, Position(454, 785,6))
addTravelKeyword('eneral', 55, Position(1183, 1279,7))
addTravelKeyword('gray island', 135, Position(182, 1310,7))

keywordHandler:addKeyword({'sail'}, StdModule.say, {npcHandler = npcHandler, text = 'I can bring you to {Verona}, {Bluffgard}, {Woundhill Bay}, {Niflheim}, {Salazart}, {Feldarin}, {Eneral} or {Gray Island}.'})
