...
addTravelKeyword('okolnir', 200, Position(236, 195, 7))
addTravelKeyword('niflheim', 150, Position(437, 375, 7))
addTravelKeyword('isle of evil', 230, Position(569, 230, 7))

keywordHandler:addKeyword({'travel'}, StdModule.say, {npcHandler = npcHandler, text = 'I can bring you to {Okolnir}, {Niflheim} or {Isle Of Evil}.'})
