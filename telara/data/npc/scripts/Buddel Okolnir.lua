...
addTravelKeyword('niflheim', 120, Position(437, 375, 7))
addTravelKeyword('svalbard', 175, Position(539, 403, 7))
addTravelKeyword('isle of evil', 250, Position(569, 230, 7))

keywordHandler:addKeyword({'travel'}, StdModule.say, {npcHandler = npcHandler, text = 'I can bring you to {Niflheim}, {Svalbard} or {Isle Of Evil}.'})
