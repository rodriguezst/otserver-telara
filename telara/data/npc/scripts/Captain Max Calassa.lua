...
addTravelKeyword('woundhill bay', 200, Position(775, 949, 6))

npcHandler:setMessage(MESSAGE_GREET, "Welcome on board, noble |PLAYERNAME|. I can bring you to {Woundhill Bay}.")
