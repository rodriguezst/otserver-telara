...
addTravelKeyword('tibia', 175, Position(320, 575, 7))

keywordHandler:addKeyword({'travel'}, StdModule.say, {npcHandler = npcHandler, text = 'I can take you back to the continent of {tibia}.'})


npcHandler:setMessage(MESSAGE_GREET, "Welcome on board, |PLAYERNAME|. Where do you want to {travel} to now?")
