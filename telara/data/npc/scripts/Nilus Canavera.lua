...
addTravelKeyword('lizard camp', 175, Position(293, 1546, 7))

keywordHandler:addKeyword({'sail'}, StdModule.say, {npcHandler = npcHandler, text = 'I can bring you to {Lizard Camp}.'})
