...
local config = {
	...
	vocations = {
		["sorcerer"] = {
			...
			--container brown mushroom, mana potion
			{{2789, 20}, {7620, 1}, {18559, 1}}
		},
		...
		["paladin"] = {
			...
			vocationId = 3,
			--equipment dwrven shield, 1 spear, ranger's cloak, ranger legs scarf, legion helmet
			{{2525, 1}, {2389, 1}, {2660, 1}, {8923, 1}, {2643, 1}, {2661, 1}, {2480, 1}},
			--container brown mushroom, health potion, bow, 50 arrow
			{{2789, 20}, {7618, 1}, {2456, 1}, {2544, 50}, {18559, 1}}
		},
		...
		["knight"] = {
			...
			--container jagged sword, brown mushroom, daramian mace, health potion
			{{8602, 1}, {2789, 20}, {2439, 1}, {7618, 1}, {18559, 1}}
		}
	}
}
...
local function creatureSayCallback(cid, type, msg)
	...
	if npcHandler.topic[cid] == 0 then
		if msgcontains(msg, "yes") then
			npcHandler:say("IN WHICH TOWN DO YOU WANT TO LIVE: {VERONA}?", cid)
	...
	elseif npcHandler.topic[cid] == 3 then
		if msgcontains(msg, "yes") then
			...
			player:sendTextMessage(MESSAGE_EVENT_ADVANCE, "You have received Adventurer's Stone in your backpack, essential item to access the Offline Trainer's Room and the server casinos.")
