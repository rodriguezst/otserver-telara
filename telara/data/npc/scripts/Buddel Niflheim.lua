...
addTravelKeyword('okolnir', 190, Position(236, 195, 7))
addTravelKeyword('svalbard', 250, Position(539, 403, 7))
addTravelKeyword('isle of evil', 255, Position(569, 230, 7))

keywordHandler:addKeyword({'travel'}, StdModule.say, {npcHandler = npcHandler, text = 'I can bring you to {Okolnir}, {Svalbard} or {Isle Of Evil}.'})
