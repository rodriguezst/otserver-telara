local config = {
	WallPositions = {
		[1] = Position({x=1954, y=674, z=10}),
		[2] = Position({x=1954, y=675, z=10}),
		[3] = Position({x=1954, y=676, z=10}),
		[4] = Position({x=1954, y=677, z=10}),
		[5] = Position({x=1954, y=678, z=10}),
		[6] = Position({x=1954, y=679, z=10}),
		[7] = Position({x=1954, y=680, z=10}),
		[8] = Position({x=1954, y=681, z=10}),
		[9] = Position({x=1954, y=682, z=10})
	},
	walldown = 1526,
	wallup = 1049
}
