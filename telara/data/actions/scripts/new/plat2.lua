local config = {
	bridgePositions = {
		{position = Position(792, 368, 13), groundId = 598},
		{position = Position(791, 368, 13), groundId = 598}
	},
	leverPositions = {
		Position(821, 366, 14)
	},
	relocatePosition = Position(794, 367, 13),
	relocateMonsterPosition = Position(794, 369, 13),
	bridgeId = 5770
}
