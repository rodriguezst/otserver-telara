-----------Config-----------
local message = "You have found Omar's Diary."
----------End Config---------
...
doPlayerSendTextMessage(cid,25,"Gamemasters are not able to collect rewards from the quests.")
    ...
    if getPlayerStorageValue(cid,1961) == -1 then
        doPlayerAddItem(cid, 1961, 1)
        doPlayerSendTextMessage(cid,25,message)
        doSendMagicEffect(frompos, 12)
        setPlayerStorageValue(cid,1961,1)

    elseif getPlayerStorageValue(cid,1961) == 1 then
