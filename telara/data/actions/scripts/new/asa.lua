...
gatepos = {x=765, y=466, z=14, stackpos=1}
...
doCreatureSay(cid, "You have awaken Asazor! Defeat him!", TALKTYPE_ORANGE_2, getCreaturePosition(cid))
...
wall0pos = {x=796, y=463, z=14, stackpos=1}
...
doItemSetAttribute(Game.createItem(1945, 1, {x=765, y=466, z=14}), "uid", 60431)
Game.createItem(1091, 1, {x=796, y=463, z=14, stackpos=1})
return TRUE
end