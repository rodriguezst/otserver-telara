-----------Config-----------
local message = "You have found a Rewards!"
----------End Config---------
...
doPlayerSendTextMessage(cid,25,"Gamemasters are not able to collect rewards from the quests.")
    ...
    if getPlayerStorageValue(cid,19201) == -1 then
        doPlayerAddItem(cid, 16111, 1)
        doPlayerSendTextMessage(cid,25,message)
        doSendMagicEffect(frompos, 12)
        setPlayerStorageValue(cid,19201,1)

    elseif getPlayerStorageValue(cid,19201) == 1 then
