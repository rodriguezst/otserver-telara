-----------Config-----------
local message = "You have found a boots of haste!"
----------End Config---------
...
doPlayerSendTextMessage(cid,25,"Gamemasters are not able to collect rewards from the quests.")
    ...
    if getPlayerStorageValue(cid,35013) == -1 then
        doPlayerAddItem(cid, 2195, 1)
        doPlayerSendTextMessage(cid,25,message)
        doSendMagicEffect(frompos, 12)
        setPlayerStorageValue(cid,35013,1)

    elseif getPlayerStorageValue(cid,35013) == 1 then
