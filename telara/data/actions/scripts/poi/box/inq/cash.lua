-----------Config-----------
local message = "You have found 4 crystal coins!"
----------End Config---------
...
if getPlayerStorageValue(cid,66666) == -1 then
    if getPlayerStorageValue(cid,35025) == -1 then
        doPlayerAddItem(cid, 2160, 4)
        doPlayerSendTextMessage(cid,25,message)
        doSendMagicEffect(frompos, 12)
        setPlayerStorageValue(cid,35025,1)

    elseif getPlayerStorageValue(cid,35025) == 1 then
