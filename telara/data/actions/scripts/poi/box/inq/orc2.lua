-----------Config-----------
local message = "You have found a royal helmet!"
----------End Config---------
...
doPlayerSendTextMessage(cid,25,"Gamemasters are not able to collect rewards from the quests.")
    ...
    if getPlayerStorageValue(cid,35036) == -1 then
        doPlayerAddItem(cid, 2498, 1)
        doPlayerSendTextMessage(cid,25,message)
        doSendMagicEffect(frompos, 12)
        setPlayerStorageValue(cid,35036,1)

    elseif getPlayerStorageValue(cid,35036) == 1 then
