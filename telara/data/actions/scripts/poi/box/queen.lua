-----------Config-----------
local message = "You have found a queens sceptre!"
----------End Config---------
...
doPlayerSendTextMessage(cid,25,"Gamemasters are not able to collect rewards from the quests.")
    ...
    if getPlayerStorageValue(cid,37010) == -1 then
        doPlayerAddItem(cid, 7410, 1)
        doPlayerSendTextMessage(cid,25,message)
        doSendMagicEffect(frompos, 12)
        setPlayerStorageValue(cid,37010,1)

    elseif getPlayerStorageValue(cid,37010) == 1 then
