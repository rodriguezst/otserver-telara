local config = {
    message = "Você ganhou Demon Addon", -- Mensagem para o player
    message_fail = "Você ja ganhou este Addon!", -- Mensagem para o player caso ele jÃ¡ tenha passado pelo piso
    outfits = {male = 541, female = 542}, -- OutfitID do addon que o player vai ganhar
    addons = 3, -- Os addons que o player ganharÃ¡, OBS .: 1 = 1Âº addon, 2 = 2Âº addon, 3 = 1Âº + 2Âº addon
    storage = 13722, -- Storage que o player vai receber
    tileUid = 13722 -- UniqueID que vocÃª vai por no map editor.
}
